...
DEFINE("FONCTION_LOG_FILE",$Actions['mise a jour']['file'] ? 'ON' : 'OFF'); 
DEFINE("FONCTION_LOG_MYSQL",$Actions['mise a jour']['mysql'] ? 'ON' : 'OFF'); 
DEFINE("FONCTION_LOG_EMAIL",$Actions['mise a jour']['email'] ? 'ON' : 'OFF'); 
if(!empty($_POST)) {
	$_POST['etat'] = "valide";
